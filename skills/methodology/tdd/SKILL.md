...
name: tdd
type: methodology
description: Test-Driven Development. This is a sequential workflow — follow these steps in order. Do not skip steps. Do not jump to implementation without a failing test first.
---
